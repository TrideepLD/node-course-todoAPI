...
describe('POST /users/login', () => {
    ...
    request(app)
      ...
      .end((err, res) => {
        ...
        User.findById(users[1]._id).then((user) => {
          ...
          /**mjacksons doc says that an alias for toInclude is toContain which doesnt work here
           * instead use toMatchObject and it will work.
           */
          done();
        }).catch((e) => done(e));
      });
  ...
  it('should reject invalid login', (done) => {
    //really similar to the above
    //instead of pasasing valid pass invalid
    //200 should be 400
    //expect x-atuh token to not exist
    //expect user tokens array has length = 0
    request(app)
      .post('/users/login')
      .send({
        email: users[1].email,
...
//Btw can use git diff to see the updates